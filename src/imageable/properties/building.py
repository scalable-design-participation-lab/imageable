...
class BuildingProperties:
    ...
    def update_height(self, height: Optional[float]) -> None:
        """
    ...
    def get_feature_names(self, exclude_materials: bool = False) -> List[str]:
        ...
        names = [
            ...
            'latitude_difference', 'n_vertices', 'shape_length',
            
            # Footprint engineered
            'complexity', 'inverse_average_segment_length', 'vertices_per_area',
            ...
            'n_size_mean', 'n_size_std', 'n_size_min', 'n_size_max',
            'n_size_cv', 'nni',
        ...
        # Image features
        names.extend([
            'average_red_channel_value', 'average_green_channel_value',
            'average_blue_channel_value', 'average_brightness', 'average_vividness',
            'mask_area', 'mask_length', 'mask_complexity',
            'number_of_edges', 'number_of_vertices',
            'average_window_x', 'average_window_y',
            'average_door_x', 'average_door_y',
    ...
    def __repr__(self) -> str:
        ...
        return (f"BuildingFeatures(id={self.building_id}, "
