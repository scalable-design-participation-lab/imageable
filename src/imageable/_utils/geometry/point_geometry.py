...
def get_heading_between_points_euclidean(
    point_1: tuple[float, float], point_2: tuple[float, float], true_north: bool = True
) -> float:
    """
...
def get_euclidean_distance_meters(point_1: tuple[float, float], point_2: tuple[float, float]) -> float:
    """
