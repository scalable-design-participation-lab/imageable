    ...
    if box_config["box_duplicates"] != "ignore":
        ...
        key_list = [
            (
                k,
                _safe_attr(
                    k, camel_killer=box_config["camel_killer_box"], replacement_char=box_config["box_safe_prefix"]
                ),
            )
            for k in keys
        ]
...
class Box(dict):
    ...
    def __convert_and_store(self, item, value):
        ...
        if isinstance(value, dict) and not isinstance(value, Box):
            ...
            value = _recursive_tuples(
                value, self.__class__, recreate_tuples=True, __box_heritage=(self, item), **self.__box_config()
            )
            self[item] = value
    ...
    if yaml_support:
        ...
        @classmethod
        def from_yaml(
            cls, yaml_string=None, filename=None, encoding="utf-8", errors="strict", loader=yaml.SafeLoader, **kwargs
        ):
            """
...
class BoxList(list):
    ...
    def to_json(self, filename=None, encoding="utf-8", errors="strict", multiline=False, **json_kwargs):
        """
    ...
    @classmethod
    def from_json(cls, json_string=None, filename=None, encoding="utf-8", errors="strict", multiline=False, **kwargs):
        """
...
class ConfigBox(Box):
    ...
    def __dir__(self):
        return super(ConfigBox, self).__dir__() + ["bool", "int", "float", "list", "getboolean", "getfloat", "getint"]
